...
- [`pdf_doc_summary()`](https://humanpred.github.io/rpdfium/reference/pdf_doc_summary.md)
  : One-call summary of a PDF document

- [`summary(`*`<pdfium_doc>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_doc.md)
...
- [`summary(`*`<pdfium_attachment_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_attachment_list.md)
...
- [`summary(`*`<pdfium_signature_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_signature_list.md)
...
- [`summary(`*`<pdfium_bookmark_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_bookmark_list.md)
...
- [`pdf_pages_summary()`](https://humanpred.github.io/rpdfium/reference/pdf_pages_summary.md)
  : One-call summary of every page in a document
- [`summary(`*`<pdfium_page>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_page.md)
  : Page-level summary
...
- [`summary(`*`<pdfium_annot_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_annot_list.md)
...
- [`summary(`*`<pdfium_form_field_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_form_field_list.md)
...
- [`summary(`*`<pdfium_obj_list>`*`)`](https://humanpred.github.io/rpdfium/reference/summary.pdfium_obj_list.md)
...
[`pdf_form_field_set_value()`](https://humanpred.github.io/rpdfium/reference/pdf_form_field_set_value.md)
...
- [`pdf_form_reset()`](https://humanpred.github.io/rpdfium/reference/pdf_form_reset.md)
...
- [`pdf_bookmark_child_count()`](https://humanpred.github.io/rpdfium/reference/pdf_bookmark_child_count.md)
  : Number of children for a bookmark

- [`pdf_page_has_transparency()`](https://humanpred.github.io/rpdfium/reference/pdf_page_has_transparency.md)
...
- [`pdf_text_rects()`](https://humanpred.github.io/rpdfium/reference/pdf_text_rects.md)
  : Rectangles occupied by a character range

- [`pdf_text_bounded()`](https://humanpred.github.io/rpdfium/reference/pdf_text_bounded.md)
  : Extract text inside a bounding rectangle

- [`pdf_text_char_geometry()`](https://humanpred.github.io/rpdfium/reference/pdf_text_char_geometry.md)
  : Per-character geometry: transformation matrix, rotation angle, font
  weight

- [`pdf_path_set_dash_phase()`](https://humanpred.github.io/rpdfium/reference/pdf_path_set_dash_phase.md)
...
- [`pdf_font_data()`](https://humanpred.github.io/rpdfium/reference/pdf_font_data.md)
  : Extract the bytes of an embedded font

- [`pdf_font_load_cidtype2()`](https://humanpred.github.io/rpdfium/reference/pdf_font_load_cidtype2.md)
  : Load a CID Type 2 (composite TrueType) font with explicit mappings

- [`pdf_text_set_charcodes()`](https://humanpred.github.io/rpdfium/reference/pdf_text_set_charcodes.md)
...
- [`pdf_annot_remove_ink_list()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_remove_ink_list.md)
...
- [`pdf_annot_set_uri()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_set_uri.md)
...
- [`pdf_annot_add_file_attachment()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_add_file_attachment.md)
  : Attach a file to a file-attachment annotation

- [`pdf_annot_line()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_line.md)
  : Line endpoints of a line annotation

- [`pdf_annot_link()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_link.md)
  : Link metadata for a link annotation

- [`pdf_annot_set_border()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_set_border.md)
...
- [`pdf_docs_import_pages()`](https://humanpred.github.io/rpdfium/reference/pdf_docs_import_pages.md)
  : Import page ranges from a source doc into a destination doc

- [`pdf_docs_copy_viewer_preferences()`](https://humanpred.github.io/rpdfium/reference/pdf_docs_copy_viewer_preferences.md)
  :
...
- [`pdf_bitmap_info()`](https://humanpred.github.io/rpdfium/reference/pdf_bitmap_info.md)
...
- [`pdf_bitmap_buffer()`](https://humanpred.github.io/rpdfium/reference/pdf_bitmap_buffer.md)
...
- [`pdf_image_new_from_bitmap()`](https://humanpred.github.io/rpdfium/reference/pdf_image_new_from_bitmap.md)
  : Embed a bitmap as an image page-object

- [`pdf_image_extract()`](https://humanpred.github.io/rpdfium/reference/pdf_image_extract.md)
...
- [`pdf_text_obj_at_char()`](https://humanpred.github.io/rpdfium/reference/pdf_text_obj_at_char.md)
  : Look up the text page-object owning a given char by direct accessor

- [`pdf_system_fonts_default_ttf_map()`](https://humanpred.github.io/rpdfium/reference/pdf_system_fonts_default_ttf_map.md)
...
- [`pdf_annot_set_font_color()`](https://humanpred.github.io/rpdfium/reference/pdf_annot_set_font_color.md)
  : Set the font color of an annotation

- [`pdf_form_field_set_flags()`](https://humanpred.github.io/rpdfium/reference/pdf_form_field_set_flags.md)
  : Set the form-field flag bitmask on a form-field widget

- [`pdf_doc_set_focusable_subtypes()`](https://humanpred.github.io/rpdfium/reference/pdf_doc_set_focusable_subtypes.md)
...
- [`pdfium_annot_subtype_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_annot_subtype_name.md)
...
- [`pdfium_obj_type_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_obj_type_name.md)
  [`pdfium_obj_type_code()`](https://humanpred.github.io/rpdfium/reference/pdfium_obj_type_name.md)
  : PDF page-object type codes \<-\> names
- [`pdfium_segment_type_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_segment_type_name.md)
  [`pdfium_segment_type_code()`](https://humanpred.github.io/rpdfium/reference/pdfium_segment_type_name.md)
  : Path-segment type codes \<-\> names
- [`pdfium_form_field_type_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_form_field_type_name.md)
  [`pdfium_form_field_type_code()`](https://humanpred.github.io/rpdfium/reference/pdfium_form_field_type_name.md)
  : Form-field type codes \<-\> names
- [`pdfium_action_type_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_action_type_name.md)
  [`pdfium_action_type_code()`](https://humanpred.github.io/rpdfium/reference/pdfium_action_type_name.md)
  : Link / page action type codes \<-\> names
- [`pdfium_dest_view_name()`](https://humanpred.github.io/rpdfium/reference/pdfium_dest_view_name.md)
  [`pdfium_dest_view_code()`](https://humanpred.github.io/rpdfium/reference/pdfium_dest_view_name.md)
