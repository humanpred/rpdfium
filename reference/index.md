...
- [`pdf_viewer_preferences()`](https://humanpred.github.io/rpdfium/reference/pdf_viewer_preferences.md)
  : Read the document's viewer preferences

- [`pdf_viewer_preference_by_name()`](https://humanpred.github.io/rpdfium/reference/pdf_viewer_preference_by_name.md)
  :
...
- [`pdf_named_dest_by_name()`](https://humanpred.github.io/rpdfium/reference/pdf_named_dest_by_name.md)
...
- [`pdf_bookmark_find()`](https://humanpred.github.io/rpdfium/reference/pdf_bookmark_find.md)
...
- [`pdf_pages_reorder()`](https://humanpred.github.io/rpdfium/reference/pdf_pages_reorder.md)
  : Reorder pages
- [`pdf_merge()`](https://humanpred.github.io/rpdfium/reference/pdf_merge.md)
