...
# nativeRaster bitmaps are drawn with grid or with rasterImage() inside
# a manually-opened plot. The simplest path:
op <- graphics::par(mar = c(0, 0, 0, 0))
plot.new()
plot.window(xlim = c(0, ncol(bmp)), ylim = c(0, nrow(bmp)),
            asp = 1)
graphics::rasterImage(bmp, 0, 0, ncol(bmp), nrow(bmp))
graphics::par(op)
```
