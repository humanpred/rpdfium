...
cpp_annot_get <- function(page_ptr, index_zero_based) {
...
cpp_annot_flags <- function(annot_ptr) {
    .Call(`_pdfium_cpp_annot_flags`, annot_ptr)
}

cpp_annot_bounds <- function(annot_ptr) {
    .Call(`_pdfium_cpp_annot_bounds`, annot_ptr)
}

cpp_annot_string_value <- function(annot_ptr, key) {
    .Call(`_pdfium_cpp_annot_string_value`, annot_ptr, key)
}

cpp_annot_color <- function(annot_ptr, interior) {
    .Call(`_pdfium_cpp_annot_color`, annot_ptr, interior)
}

cpp_annot_border <- function(annot_ptr) {
    .Call(`_pdfium_cpp_annot_border`, annot_ptr)
}

cpp_annot_font_size <- function(annot_ptr, doc_ptr) {
    .Call(`_pdfium_cpp_annot_font_size`, annot_ptr, doc_ptr)
}

cpp_annot_font_color <- function(annot_ptr, doc_ptr) {
    .Call(`_pdfium_cpp_annot_font_color`, annot_ptr, doc_ptr)
}

cpp_annot_has_attachment_points <- function(annot_ptr) {
...
cpp_annot_appearance <- function(page_ptr, annot_index_zero, appearance_mode) {
    .Call(`_pdfium_cpp_annot_appearance`, page_ptr, annot_index_zero, appearance_mode)
}

cpp_link_annot_at_point <- function(page_ptr, x, y) {
    .Call(`_pdfium_cpp_link_annot_at_point`, page_ptr, x, y)
}

cpp_obj_marked_content_id <- function(obj_ptr) {
    .Call(`_pdfium_cpp_obj_marked_content_id`, obj_ptr)
}

cpp_doc_focusable_subtypes <- function(doc_ptr) {
