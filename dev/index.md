...
([`vignette("getting-started", package = "pdfium")`](https://humanpred.github.io/rpdfium/dev/articles/getting-started.md),
...
[`LICENSE.md`](https://humanpred.github.io/rpdfium/dev/LICENSE.md) and
[`dev/decisions/ADR-003-binary-distribution.md`](https://humanpred.github.io/rpdfium/dev/dev/decisions/ADR-003-binary-distribution.md).
