...
[macos-segfault-triage.md](macos-segfault-triage.md) and
[macos-asan-ci-arch-block.md](macos-asan-ci-arch-block.md). The ASan-CI
arm64/arm64e block is now moot — we did not need a runtime repro; a
source audit of the pinned PDFium found the defect.
