...
| Read text with per-token bounding boxes | `pdftools::pdf_data()` (Poppler-precision) **or** [`pdfium::pdf_text_runs()`](https://humanpred.github.io/rpdfium/reference/pdf_text_runs.md) (PDFium-precision, plus font flags) |
| Render a page to a bitmap | `pdftools::pdf_render_page()` **or** [`pdfium::pdf_render_page()`](https://humanpred.github.io/rpdfium/reference/pdf_render_page.md) |
...
- **OCR and general image processing** — `magick` is the right tool for
  ...
  [`pdfium::pdf_render_page()`](https://humanpred.github.io/rpdfium/reference/pdf_render_page.md)
